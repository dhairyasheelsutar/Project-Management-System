...
@WebServlet("/review_2_add_comment")
public class review_2_add_comment extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public review_2_add_comment() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userid == null) {
			...
			String review_2 = request.getParameter("comment2");
			...
			Comment comment = new Comment(grpid, tid, temp_store1 ,review_2,  temp_store3 , temp_store4 );
			String error = "";	
			...
			request.setAttribute("comment2", error);

...
@WebServlet("/review_4_add_comment")
public class review_4_add_comment extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public review_4_add_comment() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userid == null) {
			...
			String review_4 = request.getParameter("comment4");
			...
			Comment comment = new Comment(grpid, tid, temp_store1 , temp_store2 , temp_store3 , review_4 );
			String error = "";	
			...
			request.setAttribute("comment4", error);

...
public class Review_2 {
	...
	protected static String db_table = "review_2";
	protected static String[] db_fields = {"survey","design","features","planning","basic","skills","qa","summarize","total"};
	...
	public Review_2(String sid,String survey,String design,String features,String planning,String basic,String skills,String qa,String summarize,String total) {
		this.sid=sid;
		this.survey=survey;
		this.design=design;
	...
	public String[] init() {
		String[] db_values = {'"'+this.survey+'"',this.design,this.features,this.planning,this.basic,this.skills,this.qa,'"'+this.summarize+'"',this.total};
		return db_values;
	}

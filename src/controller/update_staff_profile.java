...
@WebServlet("/update_staff_profile")
public class update_staff_profile extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public update_staff_profile() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userid == null) {
			...
			request.getRequestDispatcher("staff_profile").forward(request, response);
